...
def dog_img(fnm, fwhm = 3, verbose=0):
...
def dog_ram(fnm, fwhm = 3, verbose=0):
    out_img = dog_img(fnm, fwhm, verbose)
    return out_img.to_bytes()
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        ...
        sys.exit()
    fnm = sys.argv[1]
    out_img = dog_img(fnm, fwhm=3, verbose=1)
